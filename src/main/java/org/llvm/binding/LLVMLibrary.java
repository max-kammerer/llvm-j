...
public class LLVMLibrary {
	...
	public static abstract class LLVMMemoryManagerAllocateCodeSectionCallback extends Callback<LLVMMemoryManagerAllocateCodeSectionCallback > {
		abstract public Pointer<Byte > apply(Pointer<? > Opaque, Pointer<Integer > Size, int Alignment, int SectionID, Pointer<Byte > SectionName);
	};
	public static abstract class LLVMMemoryManagerAllocateDataSectionCallback extends Callback<LLVMMemoryManagerAllocateDataSectionCallback > {
		abstract public Pointer<Byte > apply(Pointer<? > Opaque, Pointer<Integer > Size, int Alignment, int SectionID, Pointer<Byte > SectionName, int IsReadOnly);
	};
	 ...
	 * call to exit(1).<br>
	 * Original signature : <code>void LLVMInstallFatalErrorHandler(LLVMFatalErrorHandler)</code>
	 */
	public static void LLVMInstallFatalErrorHandler(Pointer<LLVMLibrary.LLVMFatalErrorHandler > Handler) {
	 ...
	 * Original signature : <code>void LLVMResetFatalErrorHandler()</code>
	 */
	native public static void LLVMResetFatalErrorHandler();
	/**
	 ...
	 * crash.<br>
	 * Original signature : <code>void LLVMEnablePrettyStackTrace()</code>
	 */
	native public static void LLVMEnablePrettyStackTrace();
	/**
	...
	/** Original signature : <code>LLVMValueRef LLVMBuildAddrSpaceCast(LLVMBuilderRef, LLVMValueRef, LLVMTypeRef, const char*)</code> */
	public static LLVMLibrary.LLVMValueRef LLVMBuildAddrSpaceCast(LLVMLibrary.LLVMBuilderRef LLVMBuilderRef1, LLVMLibrary.LLVMValueRef Val, LLVMLibrary.LLVMTypeRef DestTy, Pointer<Byte > Name) {
		return new LLVMLibrary.LLVMValueRef(LLVMBuildAddrSpaceCast(Pointer.getPeer(LLVMBuilderRef1), Pointer.getPeer(Val), Pointer.getPeer(DestTy), Pointer.getPeer(Name)));
	}
	@Ptr 
	 ...
	 */
	public static void LLVMAddTargetData(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMPassManagerRef PM) {
	 ...
	 * Original signature : <code>void LLVMAddInternalizePass(LLVMPassManagerRef, unsigned)</code>
	 */
	public static void LLVMAddInternalizePass(LLVMLibrary.LLVMPassManagerRef LLVMPassManagerRef1, int AllButMain) {
		LLVMAddInternalizePass(Pointer.getPeer(LLVMPassManagerRef1), AllButMain);
	}
	protected native static void LLVMAddInternalizePass(@Ptr long LLVMPassManagerRef1, int AllButMain);
	/**
	...
	/** Conversion Error : _Tp (failed to convert type to Java (undefined type)) */
	/** Conversion Error : _Iffalse (failed to convert type to Java (undefined type)) */
